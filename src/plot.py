...
# create dataframe for 1 MG (table, not matrix) -> not necessary
...
# store table (data frame) into an existing excel file! Careful, need to store it in .csv file!
...
df.to_csv(
    "C:/Users/zhaox/PycharmProjects/BachelorThesis/letter_results/pruning_cost_1.6_dist_0.9_train/isomorphism_table.csv")
